...
################################################################################
## Form generated from reading UI file 'geninterfacefucIvW.ui'
##
...
"}")
        ...
        self.open_close_side_bar_btn.setMaximumSize(QSize(200, 200))
        icon7 = QIcon()
        icon7.addFile(u":/icons/icons/align-right.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.open_close_side_bar_btn.setIcon(icon7)
        self.open_close_side_bar_btn.setIconSize(QSize(24, 24))

        self.verticalLayout_8.addWidget(self.open_close_side_bar_btn, 0, Qt.AlignTop)
...
"border-bottom: 3px solid rgb(230,5,64);")
        ...
        sizePolicy2.setHeightForWidth(self.restore_window_button.sizePolicy().hasHeightForWidth())
        self.restore_window_button.setSizePolicy(sizePolicy2)
        ...
        self.horizontalLayout_5.addWidget(self.restore_window_button, 0, Qt.AlignRight)
